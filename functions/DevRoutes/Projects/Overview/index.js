...
const baseDB = "projects-overview_dev";
...
dev.get("/api/projects/overview/get/:id", authenticate, async (req, res) => {
  try {
...
dev.get("/api/projects/overview/getAll", authenticate, async (req, res) => {
  try {
...
// update overview
dev.put("/api/projects/overview/update/:id", authenticate, async (req, res) => {
  try {
    checkRequiredParams(["id"], req.params);
    checkRequiredParams(
      [
