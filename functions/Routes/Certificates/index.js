...
const baseDB = "certificates";

// create a certificate
app.post("/api/certificates/create", authenticate, async (req, res) => {
  try {
...
app.get("/api/certificates/get/:id", authenticate, async (req, res) => {
  try {
...
app.get("/api/certificates/getAll", authenticate, async (req, res) => {
  try {
...
// update certificates
app.put("/api/certificates/update/:id", authenticate, async (req, res) => {
  try {
    checkRequiredParams(["id"], req.params);
...
// delete certificate
app.delete("/api/certificates/delete/:id", authenticate, async (req, res) => {
  try {
    checkRequiredParams(["id"], req.params);
